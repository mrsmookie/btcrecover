...
**[bc1qmrhlfyrupmx5q58nv5x94mchmru0jqtwhycllj](bitcoin:bc1qmrhlfyrupmx5q58nv5x94mchmru0jqtwhycllj?label=btcrecover)**
...
This tutorial is pretty long... you don't have to read the whole thing. Here are some places to start.
 ...
 2. (optional) Run the unit tests by double-clicking on `run-all-tests.py`. If you encounter any failures, please [report them here](https://github.com/mrsmookie/btcrecover/issues).
